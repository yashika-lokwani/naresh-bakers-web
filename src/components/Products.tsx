  ...
  const products = [
    {
      ...
      price: "₹549",
      // originalPrice: "₹38.99",
      image: "/images/Fresh_Fruit_Delight_Cake.png",
      category: "Cakes",
      rating: 4.9,
      reviewCount: 127,
      isBestseller: true,
    ...
    },
    {
      ...
      price: "₹59",
      image: "/images/Butterscotch_pastry.png",
      category: "Pastries",
      rating: 4.6,
      reviewCount: 74,
      isNew: true,
    },
    {
      ...
      description:
        "A soft, fluffy pastry layered with creamy frosting and filled with fresh blueberry flavor, topped with juicy blueberries for a refreshing treat!",
      price: "₹59",
      image: "/images/Blueberry_pastry.png",
      category: "Pastries",
      rating: 4.9,
      reviewCount: 92,
      isBestseller: true,
    },
    {
      ...
      name: "Almond Cookies",
      description:
        "Crispy golden cookies topped with crunchy almond slices, offering a rich, nutty flavor and a perfectly balanced sweetness!",
      price: "₹479",
    ...
    },
    {
      ...
      name: "Pista Cookies",
      description:
        "Crunchy golden cookies topped with rich pistachio bits, offering a delightful nutty flavor and perfect sweetness in every bite!",
      price: "₹479",
    ...
    },
    {
      ...
      description:
        "Indulge in wholesome cookies filled with crunchy nuts and sweet raisins, creating a perfect balance of flavor and texture!",
      price: "₹479",
    ...
    <section className="py-6 ">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 relative">
        ...
        <div className="relative">
          {/* Category Filters */}
          <div className="sticky z-25 top-30 flex justify-center pb-6">
            <div className="inline-flex items-center gap-4 bg-white/90 backdrop-blur-sm rounded-2xl p-2 shadow-lg border border-[#D4A57433]">
              {categoryButtons}
            </div>
          </div>
        ...
        <div className="text-center mt-20 flex items-center justify-center">
          <div className="border-t-[0.67px] border-[#D4A5741A] shadow-[0px_8px_10px_-6px_#0000001A,0px_20px_25px_-5px_#0000001A] flex flex-col items-center gap-4 w-fit py-10 px-8 rounded-xl">
            ...
            <p className="text-muted-foreground max-w-md text-[#866741]">
              Explore our complete menu with 100+ handcrafted items, including
              seasonal specialties & custom creations.
            </p>
